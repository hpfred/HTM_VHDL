...
ARCHITECTURE structure OF HTM_Core IS
...
SIGNAL ww_Action : std_logic_vector(1 DOWNTO 0);
SIGNAL ww_MemAddress : std_logic_vector(7 DOWNTO 0);
SIGNAL ww_Data : std_logic_vector(7 DOWNTO 0);
SIGNAL ww_ProcID : std_logic_vector(1 DOWNTO 0);
SIGNAL ww_TransactionID : std_logic_vector(1 DOWNTO 0);
SIGNAL ww_TransactionStatus : std_logic_vector(2 DOWNTO 0);
...
ww_Action <= Action;
ww_MemAddress <= MemAddress;
ww_Data <= Data;
ww_ProcID <= ProcID;
ww_TransactionID <= TransactionID;
TransactionStatus <= ww_TransactionStatus;
ww_Reset <= Reset;
ww_Clock <= Clock;
ww_devoe <= devoe;
ww_devclrn <= devclrn;
...
\TransactionStatus[0]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
PORT MAP (
	...
	devoe => ww_devoe,
	oe => VCC,
	padio => ww_TransactionStatus(0));

-- Location: PIN_AE23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
\TransactionStatus[1]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
PORT MAP (
	...
	devoe => ww_devoe,
	oe => VCC,
	padio => ww_TransactionStatus(1));

-- Location: PIN_C6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
\TransactionStatus[2]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
PORT MAP (
	...
	devoe => ww_devoe,
	oe => GND,
	padio => ww_MemAddress(4));

-- Location: PIN_T2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
\MemAddress[3]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
PORT MAP (
	...
	devoe => ww_devoe,
	oe => GND,
	padio => ww_MemAddress(3));

-- Location: PIN_G11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
\MemAddress[2]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
PORT MAP (
	...
	devoe => ww_devoe,
	oe => GND,
	padio => ww_MemAddress(1));

-- Location: PIN_U9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
\MemAddress[0]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
PORT MAP (
	...
	devoe => ww_devoe,
	oe => GND,
	padio => ww_MemAddress(0));

-- Location: PIN_J13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
\Action[0]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
\TransactionID[1]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
...
PORT MAP (
	...
	devoe => ww_devoe,
	oe => GND,
	padio => ww_TransactionID(1));

-- Location: PIN_H11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
\TransactionID[0]~I\ : cycloneii_io
-- pragma translate_off
GENERIC MAP (
	input_async_reset => "none",
	input_power_up => "low",
